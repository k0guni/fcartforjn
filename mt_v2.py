...
pca.channels[0+4].duty_cycle = 0x7FFF
pca.channels[1+4].duty_cycle = 0xFFFF
pca.channels[0+4+4].duty_cycle = 0x7FFF
pca.channels[1+4+4].duty_cycle = 0xFFFF
pca.channels[0+4+4+4].duty_cycle = 0x7FFF
pca.channels[1+4+4+4].duty_cycle = 0xFFFF
time.sleep(3)

print("Forwards")
pca.channels[0].duty_cycle = 0xBFFF
pca.channels[1].duty_cycle = 0xFFFF
pca.channels[0+4].duty_cycle = 0xBFFF
pca.channels[1+4].duty_cycle = 0xFFFF
pca.channels[0+4+4].duty_cycle = 0xBFFF
pca.channels[1+4+4].duty_cycle = 0xFFFF
pca.channels[0+4+4+4].duty_cycle = 0xBFFF
pca.channels[1+4+4+4].duty_cycle = 0xFFFF
time.sleep(3)
