...
while True:
    ...
    if distances[0] < 20 and abs(distances[1]-distances[0])>=2.5:
        ccw(10)
        print("ccw")
        print(abs(distances[1]-distances[0]))
        time.sleep(0.005)
        continue
    elif distances[0] < 20 and abs(distances[1]-distances[0])<2.5:
        left(10)
        time.sleep(0.025)
        continue
    elif distances[3] < 20 and abs(distances[3]-distances[2])>=2.5:
        cw(10)
        print("ccw")
        print(abs(distances[3]-distances[2]))
        time.sleep(0.005)
        continue
    elif distances[3] < 20 and abs(distances[3]-distances[2])<2.5:
        right(10)
